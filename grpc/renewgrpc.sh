...
NUMBER_OF_CLIENTS=$(grep -c -E "^### " "/etc/xray/vmessgrpc.json")
	if [[ ${NUMBER_OF_CLIENTS} == '0' ]]; then
		clear
		echo ""
		echo "You have no existing clients! by SPIDEY"
		exit 1
	fi

	clear
	echo ""
	echo "Select the existing client you want to renew by SPIDEY"
...
echo ""
echo "==============================="
echo " SPIDEY XRAY Vmess/Vless gRPC Account Renewed by NT  "
echo "==============================="
echo "Username  : $user"
echo "Expired   : $exp4"
echo "==============================="
