...
show_vps_info() {
    ...
    echo -e "\e[1;33m -------------------------------------------------\e[0m"
    echo -e "\e[1;34m                     SPIDER WEB-SCRIPT                 \e[0m"
    echo -e "\e[1;33m -------------------------------------------------\e[0m"
...
show_menu() {
    ...
    echo -e "\e[1;34m                      SPIDEY MENU                       \e[0m"
    echo -e "\e[1;33m -------------------------------------------------\e[0m"
    echo -e ""
    ...
    echo -e "\e[1;36m x \e[0m: Exit WEB SCRIPT"
    echo -e ""
    echo -e "\e[1;33m -------------------------------------------------\e[0m"
    echo -e "\e[1;32m Client Name \e[0m: SPIDEY"
    echo -e "\e[1;32m Expired     \e[0m: PREMIUM"
    echo -e "\e[1;32m SCRIPT BY   \e[0m: SPIDEY "
    echo -e "\e[1;32m MADE BY     \e[0m: SPIDER WEB "
    echo -e "\e[1;33m -------------------------------------------------\e[0m"
    echo -e ""
